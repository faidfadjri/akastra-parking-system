...
<section class="main-section">
    ...
    <div class="headline-wrapper">
        <div class="d-flex align-items-center gap-2 m-0 p-0">
            ...
            <h1 class="headline m-0 p-0">Area Stall BP</h1>
        </div>
            ...
            <div class="row">
                <div class="col-12 pb-5">
                    <div class="d-flex parkir-wrap">
                        ...
                        <!-- Area Gudang & Deretan Sparepart GR -->
                            ...
                            <div class="d-flex flex-column gap-2 justify-content-start">
                                ...
                                <div class="d-flex gap-2 flex-column align-items-end">
                                    <?php for ($position = 1; $position <= 11; $position++) : ?>
                                        ...
                                        <?php $seatOrientation = 'seat-horizontal-wide' ?>

                                        <?php if ($position == 7 || $position == 9) {
                                            $seatOrientation = 'seat-horizontal-oven seat-yellow';
                                        } ?>
                                        <?php if ($position == 11) {
                                            $seatOrientation = 'seat-horizontal-oven seat-green';
                                        } ?>
                                        <?php if ($position == 6): ?>
                                            <div class="seat seat-horizontal-wide seat-disabled">
                                                Rak Group A
                                            </div>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <a class="seat-default <?= $seatOrientation; ?>" grup="I" position="<?= $position; ?>" parking-name="Stall BP" id="<?= rand(time() * $position, time() * 2000); ?>">
                            ...
                            <?php for ($grup = 1; $grup <= 3; $grup++) : ?>
                                ...
                                <div class="d-flex gap-2 flex-column">
                                    <?php for ($position = $posStart; $position <= $posEnd; $position++) : ?>
                                        ...
                                        <?php
                                        $seat = 'seat seat-vertical-short';
                                        if ($position < 4 || ($position > 7 && $position < 11)) {
                                            $seat = 'seat-vertical-short seat-yellow';
                                        }

                                        if (($position > 3 && $position < 8) || ($position > 10 && $position < 17) || ($position > 19)) {
                                            $seat = 'seat-vertical-short seat-green';
                                        }
                                        ?>
                                        <?php $key = $controller->cari_parkir($grupJ, $position); ?>
                                        <a class="<?= $seat ?>" grup="J" position="<?= $position; ?>" parking-name="Parkiran Bayangan BP" id="<?= rand(time() * $position, time() * 2000); ?>">
                        ...
                        <div class="ms-3">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php for ($position = 1; $position <= 2; $position++) : ?>
                                            ...
                                            <a class="seat-default seat-vertical-wide" style="height: 180px" grup="L" position="<?= $position; ?>" parking-name="Stall BP" id="<?= rand(time() * $position, time() * 2000); ?>">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex gap-1 mb-3">
                                    <?php for ($position = 1; $position <= 9; $position++) : ?>
                                        <?php $class = 'seat-default seat-vertical-wide' ?>
                                        <?php if ($position == 5) : ?>
                                        ...
                                        <?php else : ?>
                                            <?php if ($position >= 7) $class = 'seat-default seat-vertical'; ?>
                                ...
                                <div class="mb-3 gap-2">
                                    <?php for ($grup = 1; $grup <= 2; $grup++) : ?>
                                        ...
                                        ?>
                                        <div class="d-flex gap-1 mb-1 z-index-99">
                                            <?php for ($position = $posStart; $position <= $posEnd; $position++) : ?>
                                                <?php if ($position == 1) : ?>
                                ...
                                <div class="d-flex gap-1 justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <?php for ($position = 1; $position <= 7; $position++) : ?>
                                            ...
                                            <a class="seat-default seat-vertical" grup="O" position="<?= $position; ?>" parking-name="Stall BP" id="<?= rand(time() * $position, time() * 2000); ?>">
